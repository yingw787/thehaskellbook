...
```haskell
-- Why do we need `Monad`? If you're sequencing functorial / monadic structure,
-- you need to crunch that monadic structure at each stage for later
-- calculations. Otherwise, you would have to couple the stages together, which
-- nullifies any hope of composability.
